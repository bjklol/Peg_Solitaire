...
undo_move_down(r,c:INTEGER)
	do
		board.set_status (r, c, board.occupied_slot)
		board.set_status (r + 1, c, board.occupied_slot)
		board.set_status (r + 2, c, board.unoccupied_slot)
	end

undo_move_up(r,c:INTEGER)
	do
		board.set_status (r    , c, board.occupied_slot)
		board.set_status (r - 1, c, board.occupied_slot)
		board.set_status (r - 2, c, board.unoccupied_slot)
...
undo_move_left(r,c:INTEGER)
	do
		board.set_status (r, c    , board.occupied_slot)
		board.set_status (r, c - 1, board.occupied_slot)
		board.set_status (r, c - 2, board.unoccupied_slot)
	end

undo_move_right(r,c:INTEGER)
	do
		board.set_status (r, c    , board.occupied_slot)
		board.set_status (r, c + 1, board.occupied_slot)
		board.set_status (r, c + 2, board.unoccupied_slot)
